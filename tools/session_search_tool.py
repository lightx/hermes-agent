...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "Before calling this, check the recent turns of the current session if the user "
        "might just be referring to what you're already discussing. Use session_search "
        "for genuinely cross-session recall.\n\n"
